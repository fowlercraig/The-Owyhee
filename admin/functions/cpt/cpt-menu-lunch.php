...
function create_menu_lunch() {
	register_post_type('menu-lunch',
		array (
			'labels' => array(
				'name' => __('Foods - Lunch', 'gp'),
				'singular_name' => __('Lunch', 'gp'),
...
function create_menu_lunch_taxonomy() {
	register_taxonomy(
		...
		'hierarchical' => true,
		'rewrite' => array( 'slug' => 'lunch/category', 'with_front' => false ),
...
$menu_lunch_metabox = array(
	...
	'fields' => array(
		array(  
			"name" => __('Lunch Options', 'gp'),
			"type" => "heading"
		),
		array(  
			"name" => __('Lunch Price', 'gp'),
