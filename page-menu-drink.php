                                    ...
                                    if ($taxonomy_terms) {
                                        ...
                                        $gp_query = new WP_Query($args);
                                            ...
                                            if ($gp_query->have_posts()) { ?>
                                                ...
                                                <li><a href="#<?php echo $taxonomy_term->slug; ?>" class="scroll" title="<?php echo __($taxonomy_term->name); ?>"><?php echo __($taxonomy_term->name); ?></a></li>
                                        ...
                                        if ($gp_query->have_posts()) { ?>
                                            ...
                                            <div id="<?php echo $taxonomy_term->slug; ?>" class="list-menucard-block left">
                                                ...
                                                <header class="list-menucard-block-header">
                                                    <h2><?php echo __($taxonomy_term->name); ?></h2>
                                                    <?php if (!empty($taxonomy_term->description)) { ?>
                                                        <p><?php echo __($taxonomy_term->description); ?></p>
                                                    <?php } ?>
                                                        ...
                                                        <article id="post-<?php the_ID(); ?>" class="post left <?php if(has_post_thumbnail()) { ?>with-image<?php } ?>">
                                                            ...
                                                            <div class="post-content right">
                                                                ...
                                                                <header class="post-header">
                                                                    <h3 class="left">
                                                                        <?php if (get_post_meta($post->ID, 'gp_menu_drink_price', true)) { ?>
                                                                            <span class="post-price right"><?php echo stripslashes(__(get_post_meta($post->ID, 'gp_menu_drink_price', true))); ?></span>
                                                                        <?php } ?>
                                                                        <?php if (get_option('gp_menu_drink_link') != 'No') { ?>
                                                                ...
                                                                <p class="post-description left">
                                                                    <?php echo stripslashes(__(get_post_meta($post->ID, 'gp_menu_drink_description', true))); ?>
                                                                </p><!-- post-description -->
                                                                <?php } ?>
