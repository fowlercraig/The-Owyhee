                                                        ...
                                                        <article id="post-<?php the_ID(); ?>" class="post left <?php if(has_post_thumbnail()) { ?>with-image<?php } ?>">
                                                            ...
                                                            <div class="post-content right">
                                                                ...
                                                                <header class="post-header">
                                                                    <h3 class="left">
                                                                        <?php if (get_post_meta($post->ID, 'gp_menu_wine_price', true)) { ?>
                                                                            <span class="post-price right"><?php echo stripslashes(__(get_post_meta($post->ID, 'gp_menu_wine_price', true))); ?></span>
                                                                        <?php } ?>
                                                                ...
                                                                <p class="post-description left">
                                                                    <?php echo stripslashes(__(get_post_meta($post->ID, 'gp_menu_wine_description', true))); ?>
                                                                </p><!-- post-description -->
                                                                <?php } ?>
