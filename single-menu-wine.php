		...
		<header class="page-header">
            <h1>
				...
				<?php if (get_post_meta($post->ID, 'gp_menu_wine_price', true)) { ?>
                    <span class="post-price round"><?php echo stripslashes(__(get_post_meta($post->ID, 'gp_menu_wine_price', true))); ?></span>
                <?php } ?>
            </h1>
        </header><!-- page-header -->
                    ...
                    <div class="single-menucard left">
                        ...
                        ?>
                                ...
                                <article class="post left">
                                    ...
                                    <div class="post-description left"><?php echo stripslashes(__(get_post_meta($post->ID, 'gp_menu_wine_description', true))); ?></div>
                                    <?php } ?>
